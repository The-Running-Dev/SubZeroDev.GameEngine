...
- **Run `/verify` first, or say that you did not.** A PR description claiming green checks without having run them is the exact failure `CLAUDE.md` names.
...
### Verified
- `<the exact command that ran>` — passed
...
- **Unit:** W49 — `design/30-slices.md` § W49 @ `a1b2c3d`
- **Criteria met:** W49.1, W49.2
- **Left undone:** W49.3 — <why>
<!-- agent:end -->
</details>
```
