...
After approved canonical edits, regenerate detailed human docs, regenerate the guide when its
meaning changed, stamp its digest, and run the documentation gate.
