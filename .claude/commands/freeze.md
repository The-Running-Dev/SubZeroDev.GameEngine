...
Write `design/FROZEN.md`. Its existence is the whole mechanism — the rule, what it gates, and the marker's format are owned by `CLAUDE.md`, *The Design Freeze*; this command only produces the file correctly and does not restate the rule.
