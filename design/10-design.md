...
Owned by [Architecture](#architecture), [Extensibility](#extensibility--ports-and-seams), and
...
Capture, Clients, and Content Packs. Exact error vocabulary belongs to `20-contract.md`.
