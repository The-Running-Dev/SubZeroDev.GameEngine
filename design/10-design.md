...
Capture, Clients, Playable Web Demo, Platform Static Host, and Content Packs. Exact error
vocabulary belongs to `20-contract.md`.
...
<!-- human-doc:start path="engine/14-platform-static-host.md" -->
---
