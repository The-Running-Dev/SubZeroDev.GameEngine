...
> no-time-passes reducers. Do not implement a counter-only `advance_ticks`: keep that verb
> unavailable until W46 runs all 20 systems.

### Where to work

- **Existing implementation draft:** `feature/w45-world-graph-kind-skeleton`, currently
  commit `0135e30`.
- **Authoritative contract:** `docs/docs/engine/12-world-graph-kind.md`, especially §§3,
  6–15.
