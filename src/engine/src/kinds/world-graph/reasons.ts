...
export const WORLD_GRAPH_REASON_CODES = [
  ...
  "invalid_inventory",
  "invalid_work_rate",
  "invalid_initial_wear",
  "undeferrable_building_meter_effect",
...
const WORLD_GRAPH_REASON_TEXT: Readonly<Record<WorldGraphReasonCode, string>> = {
  ...
  undeferrable_building_meter_effect: "This campaign has a wear effect on an effect list that cannot defer to cleanliness-wear.",
