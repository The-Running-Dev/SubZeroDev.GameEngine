...
export const moveHousingResolver: ActionResolver = {
  ...
  calculate: (state, action, ctx): ActionOutcome => {
    ...
    const changes: StateChange[] = [
      ...
      { path: "player.housing.utilitiesCents", op: "set", value: def.utilitiesCents ?? 0, reason: "action_move_housing", visible: true },
      { path: "player.housing.transportCents", op: "set", value: def.transportCents ?? 0, reason: "action_move_housing", visible: true },
  ...
  apply: (state, outcome): SimulationKindState => {
    ...
    const housing: HousingState = {
      ...
      utilitiesCents: field("utilitiesCents") as Cents,
      transportCents: field("transportCents") as Cents,
