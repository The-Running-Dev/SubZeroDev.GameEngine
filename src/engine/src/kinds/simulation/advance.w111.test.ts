...
function buildState(relationships: RelationshipState[], enrollments: CourseEnrollment[]): SimulationKindState {
  return {
    ...
    player: {
      ...
      housing: { definitionId: "housing-1", movedInWeek: 1, ownership: "renting", damage: 0, weeklyCostCents: 0, depositPaidCents: 0, rentDueWeek: 1, overdueRentCents: 0, missedPayments: 0, evictionStage: "none" },
