...
const player = {
  ...
  housing: { definitionId: "h", movedInWeek: 1, ownership: "renting" as const, damage: 0, weeklyCostCents: 0, utilitiesCents: 0, transportCents: 0, depositPaidCents: 0, rentDueWeek: 1, overdueRentCents: 0, missedPayments: 0, evictionStage: "none" as const },
