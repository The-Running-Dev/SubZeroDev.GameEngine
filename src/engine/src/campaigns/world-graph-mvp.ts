...
export const worldGraphMvpSource: WorldGraphCampaignSource = {
  ...
  // W85: no existing fixture hires two cleaners at once (each hires at most one of any
  // role) — this stays inert everywhere but the dedicated `world-graph-mvp-achievement`
  // fixture, preserving every previously committed outcome byte-for-byte.
  achievements: [{ id: "double-cleaner", text: definitionText("achievement-double-cleaner"), condition: { kind: "compare", metric: { kind: "entity_count", entity: "staff", definitionId: "cleaner" }, op: "gte", value: 2 }, hidden: false, scope: "profile", tags: [] }],
