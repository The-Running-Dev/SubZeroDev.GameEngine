...
- [x] **W45 — kind skeleton and immediate actions: merged in
      ...
      which is historical rather than a second contract authority.
- [ ] **W46 in review — deterministic tick pipeline:** fixed-order systems, bounded
      `advance_ticks`, derived streams and batch invariance are under review in
      [PR #128](https://github.com/The-Running-Dev/SubZeroDev.GameEngine/pull/128). Its implementation plan is
