...
- [ ] **W44 in review — resolution contract:** the 20-system pipeline, utility scoring,
      ...
      [PR #122](https://github.com/The-Running-Dev/SubZeroDev.GameEngine/pull/122), stacked on
      W43 for an exact review diff. The separate design plan is
      [PR #120](https://github.com/The-Running-Dev/SubZeroDev.GameEngine/pull/120); merge remains
      the T1 delivery gate.
