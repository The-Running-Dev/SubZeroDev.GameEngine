...
| [Platform Static Host](engine/14-platform-static-host.md) | The first Platform consumer: a product-owned container that serves the same verified static artifact, publishes immutably, and deliberately stops before hosted engine execution or deployment |
