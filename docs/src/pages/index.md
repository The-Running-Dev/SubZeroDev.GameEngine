...
4. The three kinds:
   [story-graph](/docs/engine/story-graph-kind),
   [simulation](/docs/engine/simulation-kind),
   [world-graph](/docs/engine/world-graph-kind)
5. [Content Packs](/docs/engine/content-packs) — how a kind becomes a campaign
6. [MVP](/docs/engine/mvp) + [TODO](/docs/engine/todo) — what ships first, in order
